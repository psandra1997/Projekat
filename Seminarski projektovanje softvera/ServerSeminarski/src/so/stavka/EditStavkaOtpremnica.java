 ...
 * @author Sandra
 */
public class EditStavkaOtpremnica extends AbstractSO{
    RepositoryStavkaOtpremnice storage;

    public EditStavkaOtpremnica() {
    ...
    protected void prediction(Object o) throws Exception {
        ...
        StavkaOtpremnice stot = (StavkaOtpremnice) o;
    }

    @Override
    protected void executeOperation(Object o) throws Exception {
        storage.edit((StavkaOtpremnice) o);
    }
